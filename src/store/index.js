...
export default createStore({
  state: {
    ...
    notifs:new Set(), read_notif:new Set(),
    versements:new Set(),
    commandes:new Set(), deleted_commandes:new Set(),
    stocks:new Set(), deleted_stocks:new Set(), validated_stocks:new Set(),
    pertes:new Set(), deleted_pertes:new Set(), validated_pertes:new Set(),
    payments:new Set(),
    produits:new Set(),
    clients:new Set(),
    stats_prod:new Set(),
    stats_client:new Set(),
